...
def train(args):
    ...
    aug_list = [
        ...
        RandomEmojiOverlay(
            p=0.1, emoji_size=(0.1, 0.3), x_pos=(0.0, 1.0), y_pos=(0.0, 1.0), seed=None
        ),
        RandomNoise(p=0.2),
    ]
    aug_hard = [
        ...
        RandomCompositeImageAndResizedCrop(
            ...
            hard_scale_lower=0.4,
            overlay_p=0.075,
            alpha_blending_p=0.075,
...
if __name__ == "__main__":
    ...
    if args.mode == "predict":
        # predict(args)
        gt_matches = Match.read_csv(args.eval_gt_path, is_gt=True)
        aggregate_preds_and_evaluate(
            Path(args.pred_output_dir), gt_matches=None, only_train_query=False
        )
