...
def train(args):
    ...
    aug_list = [
        ...
        RandomEmojiOverlay(p=0.2, emoji_size=(0.1, 0.4), x_pos=(0.0, 1.0), y_pos=(0.0, 1.0), seed=None),
        RandomNoise(p=0.3),
    ]
    aug_hard = [
        ...
        RandomCompositeImageAndResizedCrop(
            ...
            input_size=input_size, moderate_scale_lower=0.7, hard_scale_lower=0.25, overlay_p=0.1,
            alpha_blending_p=0.1, horizontal_stacking_p=0.0, vertical_stacking_p=0.0, p=1.0,
        ),
